...
//Clase principal que se encarga de iniciar la calculadora.
public class CalculadoraED {
	...
	//Metodo que se encarga de mostrar la seleccion de operaciones.
	...
	//Metodo encargado de comprobar que el número introducido para solicitar la operación es válido o no.
